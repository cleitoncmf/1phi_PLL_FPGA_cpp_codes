...
void SOGI_PLL_x64(uint1_t sinc, data_t vin,
    ...
    static data_t valpha_new =0;

    static data_t vbeta = 0;
    static data_t vbeta_new = 0;
    ...
    if(aux_sinc == sinc){
        ...
        // Computação: Variáveis algébricas do SOGI
        e = vin - valpha;
        ...
        valpha_new = valpha + Ts*w*(K*e - vbeta);
        
        // Eular Forward
        vbeta_new = vbeta + Ts*w*valpha;

        // Euler Backward -aproximado
        //vbeta_new = vbeta + Ts*w*valpha_new;
        
        //vbeta_new = vbeta + Ts*(wi_new + + Ts*Kpf*vd + w0)*valpha_new;
